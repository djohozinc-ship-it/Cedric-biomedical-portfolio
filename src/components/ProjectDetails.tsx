    ...
    return (
        <main className="project-details-page">
            ...
            <div className="project-story">
                ...
                {project.youtubeVideoId ? <section className="project-story-section video-section"><div className="section-kicker">12 · DÉMONSTRATION</div><h2><FontAwesomeIcon icon={faPlay} /> Démonstration vidéo du système SACRURO</h2><div style={{ width: '100%', aspectRatio: '16 / 9', borderRadius: '24px', overflow: 'hidden', border: '1px solid rgba(255,255,255,.12)', background: '#070a0f', boxShadow: '0 30px 80px rgba(0,0,0,.3)' }}><iframe src={`https://www.youtube.com/embed/${project.youtubeVideoId}`} title="Démonstration vidéo du système SACRURO" loading="lazy" style={{ width: '100%', height: '100%', border: 0, display: 'block' }} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen /></div></section> : null}
