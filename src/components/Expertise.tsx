            ...
            <div className="skills-grid">
                ...
                <div className="skill">
                    ...
                    <p>
                        ...
                        des moteurs électriques, realisation des schémas électriques pour système industriel et de la conception de systèmes électroniques.
                    </p>
                    <div className="flex-chips">
                        <span className="chip-title">Compétences :</span>
