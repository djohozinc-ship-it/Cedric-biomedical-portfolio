  ...
  useEffect(() => {
    ...
    try {
      ...
      const shots:Shot[]=[
        ...
        {p:[7,3.8,14],l:[12,3.2,3],fov:39,hold:7},
        {p:[7,3.0,1],l:[9.5,2.5,-3],fov:31,hold:6},
        {p:[13,3.0,-1],l:[15,2.6,-1],fov:31,hold:6},
        {p:[18,3.0,3],l:[19,2.5,3],fov:32,hold:6},
        {p:[17,3.0,7],l:[19,2.5,6],fov:32,hold:6},
        {p:[10,3.0,10],l:[9,2.5,8],fov:32,hold:6},
        {p:[2,3.0,9],l:[0,2.8,8],fov:32,hold:6},
        {p:[-1,3.0,3],l:[-1,2.8,4],fov:32,hold:6},
        {p:[-13,4.0,15],l:[-15,3.4,8],fov:36,hold:7},
        {p:[-15,4.0,3],l:[-15,3.4,8],fov:34,hold:6},
